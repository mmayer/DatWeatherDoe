...
protocol ConfigManagerType: AnyObject {
    ...
    var isShowingRiseSet: Bool { get set }
...
final class ConfigManager: ConfigManagerType {
    ...
    @Storage(key: DefaultsKeys.isShowingRiseSet.rawValue, defaultValue: false)
    public var isShowingRiseSet: Bool
